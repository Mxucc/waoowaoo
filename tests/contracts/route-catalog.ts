...
const ROUTE_FILES = [
  ...
  'src/app/api/novel-promotion/[projectId]/manual/story-to-script-submit/route.ts',
  'src/app/api/novel-promotion/[projectId]/manual/story-to-script-wait/route.ts',
  ...
  'src/app/api/novel-promotion/[projectId]/upload-panel-candidate-image/route.ts',
  'src/app/api/novel-promotion/[projectId]/upload-panel-video/route.ts',
  'src/app/api/novel-promotion/[projectId]/upload-voice-line-audio/route.ts',
